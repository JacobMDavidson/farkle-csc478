...
public class FarkleOptionsDialogTest {
	...
	public void testConstructor() {
		...
		assertTrue(farkleOptionsDialog.getPreferredSize().equals(new Dimension(750, 250)));
	...
	public void testMouseClicked() {
		...
		// Instantiate MouseEvent objects that simulate the user clicking on the above 
		// JLabels
		MouseEvent singlePlayerLabelClicked = new MouseEvent(
				singlePlayerLabel, 1, 1, 0, 0, 0, 1, false);
		MouseEvent multiPlayerLabelClicked = new MouseEvent(
				multiPlayerLabel, 1, 1, 0, 0, 0, 1, false);
		MouseEvent humanPlayerLabelClicked = new MouseEvent(
				humanPlayerLabel, 1, 1, 0, 0, 0, 1, false);
		MouseEvent computerPlayerLabelClicked = new MouseEvent(
				computerPlayerLabel, 1, 1, 0, 0, 0, 1, false);
		
		/* 
		 * When the dialog box opens, the singlePlayerLabel is highlighted, test the click 
		 * on the multiPlayerLabel.
		 */
		...
		/* 
		 * Two Player Mode is highlighted, simulate a click on "Computer Opponent"
		 */
