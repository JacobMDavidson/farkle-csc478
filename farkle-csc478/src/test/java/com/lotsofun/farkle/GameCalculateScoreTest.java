...
/**
 * The GameCalculateScoreTest class tests the calculateScore(List<Integer>,
 * boolean) and the calculateHighestScore(List<Integer>) methods and the of the
 * Game class for every possible combination of dice to ensure they comply with
 * the requirement 6.0.0, scoring, of the specific requirements in the
 * requirements document. This includes rolls of 1, 2, 3, 4, 5 or 6 dice.
 * 
...
public class GameCalculateScoreTest {
	...
	/**
	 * List of strings representing rolls for permutations of die that are not 1
	 * or 5
	 */
	...
	/**
	 * The value of the second three of a kind die if two three of a kinds
	 * rolled at once
	 */
	int dieTwoValue = 0;

	/**
	 * The object array used to store the returned array from the
	 * calculateHighestScore method
	 */
	Object[] highestScore;
	...
	public void setUp() throws Exception {
		...
		// Instantiate the game option. The Game Mode used does not change the
	...
	/**
	 * Test the helper methods that calculate the dice roll permutations used to
	 * check the calculateScore method
	 */
	@Test
	public void testPermutationHelperMethods() {
		...
		// If letters anything but digits are in the string, null should be
		// returned
		...
		// If a string with no variables is passed to integerPermutations,
		// return that
	...
	/**
	 * This method tests the fringe conditions of the calculateScore method of
	 * the Game class
	 */
	...
	public void testCalculateScore1() {
		...
		/*
		 * Test 1: Check scoring for a die roll of A (A represents all die
		 * values other than 1 or 5)
		 */
		...
		// Generate all permutations of the roll and store in a list of lists of
		// integers
	...
	/**
	 * This method tests the calculateScore method of the Game class for all
	 * permutations of 2 dice, requirement 6.1.0 and 6.2.0. <br />
	 * <br />
	 * 6.1.0 Each 1 rolled is worth 100 points<br />
	 * 6.2.0 Each 5 rolled is worth 50 points
	 */
	...
	public void testCalculateScore2() {
		...
		/*
		 * Test 4: Check scoring for a die roll of AA (A represents all die
		 * values other than 1 or 5)
		 */
		...
		/*
		 * Test 5: Check scoring for a die roll of AX (A and X represent all die
		 * values other than 1 or 5)
		 */
		...
		/*
		 * Test 6: Check scoring for a die roll of 5X (X represent all die
		 * values other than 1 or 5) Requirement 6.2.0
		 */
		...
		/*
		 * Test 7: Check scoring for a die roll of 1X (X represent all die
		 * values other than 1 or 5) Requirement 6.1.0
		 */
		...
		/*
		 * Test 8: Check scoring for a die roll of 55 Requirement 6.2.0
		 */
		...
		/*
		 * Test 9: Check scoring for a die roll of 15 Requirement 6.1.0 and
		 * 6.2.0
		 */
		...
		/*
		 * Test 10: Check scoring for a die roll of 11 Requirement 6.1.0
		 */
	...
	/**
	 * This method tests the calculateScore method of the Game class for all
	 * permutations of 3 dice, requirements 6.1.0, 6.2.0, 6.3.0, and 6.4.0. <br />
	 * <br />
	 * 6.1.0 Each 1 rolled is worth 100 points<br />
	 * 6.2.0 Each 5 rolled is worth 50 points<br />
	 * 6.3.0 Three 1’s are worth 1000 points<br />
	 * 6.4.0 Three of a kind of any value other than 1 is worth 100 times the
	 * value of the die (e.g. three 4’s is worth 400 points).
	 */
	@SuppressWarnings("unchecked")
	@Test
	public void testCalculateScore3() {
		...
		/*
		 * Test 11: Check scoring for a die roll of AXY (A, X and Y each
		 * represent all die values other than 1 or 5)
		 */
		...
		/*
		 * Test 12: Check scoring for a die roll of AAX (A and X each represent
		 * all die values other than 1 or 5)
		 */
		...
		/*
		 * Test 13: Check scoring for a die roll of 5AA (A represents all die
		 * values other than 1 or 5) Requirement 6.2.0
		 */
		...
		/*
		 * Test 14: Check scoring for a die roll of 5AX (A and X represent all
		 * die values other than 1 or 5) Requirement 6.2.0
		 */
		...
		/*
		 * Test 15: Check scoring for a die roll of 1AA (A represents all die
		 * values other than 1 or 5) Requirement 6.1.0 and 6.2.0
		 */
		...
		/*
		 * Test 16: Check scoring for a die roll of 1AX (A and X represent all
		 * die values other than 1 or 5) Requirement 6.1.0
		 */
		...
		/*
		 * Test 17: Check scoring for a die roll of 55A (A represents all die
		 * values other than 1 or 5) Requirement 6.2.0
		 */
		...
		/*
		 * Test 18: Check scoring for a die roll of 15A (A represents all die
		 * values other than 1 or 5) Requirement 6.1.0 and 6.2.0
		 */
		...
		/*
		 * Test 19: Check scoring for a die roll of 11A (A represents all die
		 * values other than 1 or 5) Requirement 6.1.0
		 */
		...
		/*
		 * Test 20: Check scoring for a die roll of 155 Requirement 6.1.0 and
		 * 6.2.0
		 */
		...
		/*
		 * Test 21: Check scoring for a die roll of 115 Requirement 6.1.0 and
		 * 6.2.0
		 */
		...
		/*
		 * Test 22: Check scoring for a die roll of AAA (A represents all die
		 * values other than 1 or 5) Requirement 6.4.0
		 */
		...
		/*
		 * Test 23: Check scoring for a die roll of 555 Requirement 6.4.0
		 */
		...
		/*
		 * Test 24: Check scoring for a die roll of 111 Requirement 6.3.0
		 */
	...
	/**
	 * This method tests the calculateScore method of the Game class for all
	 * permutations of 4 dice, requirements 6.1.0, 6.2.0, 6.3.0, 6.4.0, and
	 * 6.5.0: <br />
	 * <br />
	 * 6.1.0 Each 1 rolled is worth 100 points<br />
	 * 6.2.0 Each 5 rolled is worth 50 points<br />
	 * 6.3.0 Three 1’s are worth 1000 points<br />
	 * 6.4.0 Three of a kind of any value other than 1 is worth 100 times the
	 * value of the die (e.g. three 4’s is worth 400 points).<br />
	 * 6.5.0 Four, five, or six of a kind is scored by doubling the three of a
	 * kind value for every additional matching die (e.g. five 3’s would be
	 * scored as 300 X 2 X 2 = 1200.
	 */
	@SuppressWarnings("unchecked")
	@Test
	public void testCalculateScore4() {
		...
		/*
		 * Test 25: Check scoring for a die roll of AXYZ (A, X, Y and Z each
		 * represent all die values other than 1 or 5)
		 */
		...
		/*
		 * Test 26: Check scoring for a die roll of AAXY (A, X and Y each
		 * represent all die values other than 1 or 5)
		 */
		...
		/*
		 * Test 27: Check scoring for a die roll of AAXX (A and X each represent
		 * all die values other than 1 or 5)
		 */
		...
		/*
		 * Test 28: Check scoring for a die roll of 5AXY (A, X and Y each
		 * represent all die values other than 1 or 5) Requirement 6.2.0
		 */
		...
		/*
		 * Test 29: Check scoring for a die roll of 5AAX (A and X each represent
		 * all die values other than 1 or 5) Requirement 6.2.0
		 */
		...
		/*
		 * Test 30: Check scoring for a die roll of 1AXY (A, X and Y each
		...
		/*
		 * Test 31: Check scoring for a die roll of 1AAX (A and X each represent
		 * all die values other than 1 or 5) Requirement 6.1.0
		 */
		...
		/*
		 * Test 32: Check scoring for a die roll of 55AX (A and X each represent
		 * all die values other than 1 or 5) Requirement 6.2.0
		 */
		...
		/*
		 * Test 33: Check scoring for a die roll of 55AA (A represents all die
		 * values other than 1 or 5) Requirement 6.2.0
		 */
		...
		/*
		 * Test 34: Check scoring for a die roll of 15AX (A and X each represent
		 * all die values other than 1 or 5) Requirement 6.1.0 and 6.2.0
		 */
		...
		/*
		 * Test 35: Check scoring for a die roll of 15AA (A represents all die
		 * values other than 1 or 5) Requirement 6.1.0 and 6.2.0
		 */
		...
		/*
		 * Test 36: Check scoring for a die roll of 11AX (A and X each represent
		 * all die values other than 1 or 5) Requirement 6.1.0
		 */
		...
		/*
		 * Test 37: Check scoring for a die roll of 55AA (A represents all die
		 * values other than 1 or 5) Requirement 6.2.0
		 */
		...
		/*
		 * Test 38: Check scoring for a die roll of 155A (A represents all die
		 * values other than 1 or 5) Requirement 6.1.0 and 6.2.0
		 */
		...
		/*
		 * Test 39: Check scoring for a die roll of 115A (A represents all die
		 * values other than 1 or 5) Requirement 6.1.0 and 6.2.0
		 */
		...
		/*
		 * Test 40: Check scoring for a die roll of AAAX (A and X represent all
		 * die values other than 1 or 5) Requirement 6.4.0
		 */
		...
		/*
		 * Test 41: Check scoring for a die roll of 555A (A represents all die
		 * values other than 1 or 5) Requirement 6.4.0
		 */
		...
		/*
		 * Test 42: Check scoring for a die roll of 111A (A represents all die
		 * values other than 1 or 5) Requirement 6.3.0
		 */
		...
		/*
		 * Test 43: Check scoring for a die roll of 5AAA (A represents all die
		...
		/*
		 * Test 44: Check scoring for a die roll of 1AAA (A represents all die
		 * values other than 1 or 5) Requirement 6.1.0 and 6.4.0
		 */
		...
		/*
		 * Test 45: Check scoring for a die roll of 1555 Requirement 6.1.0 and
		 * 6.4.0
		 */
		...
		/*
		 * Test 46: Check scoring for a die roll of 5111 Requirement 6.2.0 and
		 * 6.3.0
		 */
		...
		/*
		 * Test 47: Check scoring for a die roll of AAAA (A represents all die
		 * values other than 1 or 5) Requirement 6.5.0
		 */
		...
		/*
		 * Test 48: Check scoring for a die roll of 5555 Requirement 6.5.0
		 */
		...
		/*
		 * Test 49: Check scoring for a die roll of 1111 Requirement 6.5.0
		 */
	...
	/**
	 * This method tests the calculateScore method of the Game class for all
	 * permutations of 5 dice, requirements 6.1.0, 6.2.0, 6.3.0, 6.4.0, and
	 * 6.5.0:<br />
	 * <br />
	 * 6.1.0 Each 1 rolled is worth 100 points<br />
	 * 6.2.0 Each 5 rolled is worth 50 points<br />
	...
	public void testCalculateScore5() {
		/*
		 * Test 50: Check scoring for a die roll of AAXYZ (A, X, Y and Z each
		 * represent all die values other than 1 or 5)
		 */
		...
		/*
		 * Test 51: Check scoring for a die roll of AAXXY (A, X and Y each
		 * represent all die values other than 1 or 5)
		 */
		...
		/*
		 * Test 52: Check scoring for a die roll of 5AXYZ (A, X, Y and Z each
		 * represent all die values other than 1 or 5) Requirement 6.2.0
		 */
		...
		/*
		 * Test 53: Check scoring for a die roll of 5AAXY (A, X and Y each
		 * represent all die values other than 1 or 5) Requirement 6.2.0
		 */
		...
		/*
		 * Test 54: Check scoring for a die roll of 5AAXX (A and X each
		 * represent all die values other than 1 or 5) Requirement 6.2.0
		 */
		...
		/*
		 * Test 55: Check scoring for a die roll of 1AXYZ (A, X, Y and Z each
		 * represent all die values other than 1 or 5) Requirement 6.1.0
		 */
		...
		/*
		 * Test 56: Check scoring for a die roll of 1AAXY (A, X and Y each
		 * represent all die values other than 1 or 5) Requirement 6.1.0
		 */
		...
		/*
		 * Test 57: Check scoring for a die roll of 1AAXX (A and X each
		 * represent all die values other than 1 or 5) Requirement 6.1.0
		 */
		...
		/*
		 * Test 58: Check scoring for a die roll of 55AXY (A, X and Y each
		 * represent all die values other than 1 or 5) Requirement 6.2.0
		 */
		...
		/*
		 * Test 59: Check scoring for a die roll of 55AAX (A and X each
		 * represent all die values other than 1 or 5) Requirement 6.2.0
		 */
		...
		/*
		 * Test 60: Check scoring for a die roll of 15AXY (A, X and Y each
		 * represent all die values other than 1 or 5) Requirement 6.1.0 and
		 * 6.2.0
		 */
		...
		/*
		 * Test 61: Check scoring for a die roll of 15AAX (A and X each
		 * represent all die values other than 1 or 5) Requirement 6.1.0 and
		 * 6.2.0
		 */
		...
		/*
		 * Test 62: Check scoring for a die roll of 11AXY (A, X and Y each
		 * represent all die values other than 1 or 5) Requirement 6.1.0
		 */
		...
		/*
		 * Test 63: Check scoring for a die roll of 11AAX (A and X each
		 * represent all die values other than 1 or 5) Requirement 6.1.0
		 */
		...
		/*
		 * Test 64: Check scoring for a die roll of 155AX (A and X each
		 * represent all die values other than 1 or 5) Requirement 6.1.0 and
		 * 6.2.0
		 */
		...
		/*
		 * Test 65: Check scoring for a die roll of 155AA (A represents all die
		 * values other than 1 or 5) Requirement 6.1.0 and 6.2.0
		 */
		...
		/*
		 * Test 66: Check scoring for a die roll of 115AX (A and X each
		 * represent all die values other than 1 or 5) Requirement 6.1.0 and
		 * 6.2.0
		 */
		...
		/*
		 * Test 67: Check scoring for a die roll of 115AA (A represents all die
		 * values other than 1 or 5) Requirement 6.1.0 and 6.2.0
		 */
		...
		/*
		 * Test 68: Check scoring for a die roll of AAAXY (A, X and Y each
		...
		/*
		 * Test 69: Check scoring for a die roll of AAAXX (A and X each
		 * represent all die values other than 1 or 5) Requirement 6.4.0
		 */
		...
		/*
		 * Test 70: Check scoring for a die roll of 5AAAX (A and X each
		 * represent all die values other than 1 or 5) Requirement 6.2.0 and
		 * 6.4.0
		 */
		...
		/*
		 * Test 71: Check scoring for a die roll of 1AAAX (A and X each
		 * represent all die values other than 1 or 5) Requirement 6.1.0 and
		 * 6.4.0
		 */
		...
		/*
		 * Test 74: Check scoring for a die roll of 11AAA (A represents all die
		 * values other than 1 or 5) Requirement 6.1.0 and 6.4.0
		 */
		...
		/*
		 * Test 75: Check scoring for a die roll of 555AX (A and X each
		 * represent all die values other than 1 or 5) Requirement 6.4.0
		 */
		...
		/*
		 * Test 76: Check scoring for a die roll of 555AA (A represents all die
		 * values other than 1 or 5) Requirement 6.4.0
		 */
		...
		/*
		 * Test 77: Check scoring for a die roll of 1555A (A represents all die
		 * values other than 1 or 5) Requirement 6.1.0 and 6.4.0
		 */
		...
		/*
		 * Test 78: Check scoring for a die roll of 11555 Requirement 6.1.0 and
		 * 6.4.0
		 */
		...
		/*
		 * Test 79: Check scoring for a die roll of 111AX (A and X each
		 * represent all die values other than 1 or 5) Requirement 6.3.0
		 */
		...
		/*
		 * Test 80: Check scoring for a die roll of 111AA (A represents all die
		 * values other than 1 or 5) Requirement 6.3.0
		 */
		...
		/*
		 * Test 81: Check scoring for a die roll of 1115A (A represents all die
		 * values other than 1 or 5) Requirement 6.2.0 and 6.3.0
		 */
		...
		/*
		 * Test 82: Check scoring for a die roll of 11155 Requirement 6.2.0 and
		 * 6.3.0
		 */
		...
		/*
		 * Test 83: Check scoring for a die roll of AAAAX (A and X each
		 * represent all die values other than 1 or 5) Requirement 6.5.0
		 */
		...
		/*
		 * Test 84: Check scoring for a die roll of 5AAAA (A represents all die
		 * values other than 1 or 5) Requirement 6.2.0 and 6.5.0
		 */
		...
		/*
		 * Test 85: Check scoring for a die roll of 1AAAA (A represents all die
		 * values other than 1 or 5) Requirement 6.1.0 and 6.5.0
		 */
		...
		/*
		 * Test 86: Check scoring for a die roll of 5555A (A represents all die
		 * values other than 1 or 5) Requirement 6.5.0
		 */
		...
		/*
		 * Test 87: Check scoring for a die roll of 15555 Requirement 6.1.0 and
		 * 6.5.0
		 */
		...
		/*
		 * Test 88: Check scoring for a die roll of 1111A (A represents all die
		 * values other than 1 or 5) Requirement 6.5.0
		 */
		...
		/*
		 * Test 89: Check scoring for a die roll of 11115 Requirement 6.2.0 and
		 * 6.5.0
		 */
		...
		/*
		 * Test 90: Check scoring for a die roll of AAAAA (A represents all die
		 * values other than 1 or 5) Requirement 6.5.0
		 */
		...
		/*
		 * Test 91: Check scoring for a die roll of 55555 Requirement 6.5.0
		 */
		...
		/*
		 * Test 92: Check scoring for a die roll of 11111 Requirement 6.5.0
		 */
	...
	/**
	 * This method tests the calculateScore method of the Game class for all
	 * permutations of 6 dice, requirements 6.1.0, 6.2.0, 6.3.0, 6.4.0, 6.5.0,
	 * 6.6.0, and 6.7.0:<br />
	 * <br />
	 * 6.1.0 Each 1 rolled is worth 100 points<br />
	 * 6.2.0 Each 5 rolled is worth 50 points<br />
	 ...
	 * 6.5.0 Four, five, or six of a kind is scored by doubling the three of a
	 * kind value for every additional matching die (e.g. five 3’s would be
	 * scored as 300 X 2 X 2 = 1200.<br />
	 * 6.6.0 Three doubles (e.g. 1-1-2-2-3-3) is worth 750 points.<br />
	 * 6.7.0 A straight (e.g. 1-2-3-4-5-6), which can only be achieved when all
	 * 6 dice are rolled, is worth 1500 points.
	 */
	@SuppressWarnings("unchecked")
	@Test
	public void testCalculateScore6() {
		...
		/*
		 * Test 93: Check scoring for a die roll of AAXXYZ (A, X, Y and Z each
		 * represent all die values other than 1 or 5)
		 */
		...
		/*
		 * Test 94: Check scoring for a die roll of AAXXYY (A, X and Y each
		...
		/*
		 * Test 96: Check scoring for a die roll of 55AAXX (A and X each
		 * represent all die values other than 1 or 5) Requirement 6.6.0
		 */
		...
		/*
		 * Test 97: Check scoring for a die roll of 1155AA (A represents all die
		 * values other than 1 or 5) Requirement 6.6.0
		 */
		...
		/*
		 * Test 98: Check scoring for a die roll of 1AXY5Z (A, X, Y and Z each
		 * represent all die values other than 1 or 5) Requirement 6.7.0
		 */
		...
		/*
		 * Test 99: Check scoring for a die roll of 5AAXXY (A, X and Y each
		 * represent all die values other than 1 or 5) Requirement 6.2.0
		 */
		...
		/*
		 * Test 100: Check scoring for a die roll of 5AAXYZ (A, X, Y and Z each
		 * represent all die values other than 1 or 5) Requirement 6.2.0
		 */
		...
		/*
		 * Test 101: Check scoring for a die roll of 1AAXXY (A, X and Y each
		 * represent all die values other than 1 or 5) Requirement 6.1.0
		 */
		...
		/*
		 * Test 102: Check scoring for a die roll of 1AAXYZ (A, X, Y and Z each
		 * represent all die values other than 1 or 5) Requirement 6.1.0
		 */
		...
		/*
		 * Test 103: Check scoring for a die roll of 55AAXY (A, X and Y each
		 * represent all die values other than 1 or 5) Requirement 6.2.0
		 */
		...
		/*
		 * Test 104: Check scoring for a die roll of 55AXYZ (A, X, Y and Z each
		 * represent all die values other than 1 or 5) Requirement 6.2.0
		 */
		...
		/*
		 * Test 105: Check scoring for a die roll of 15AAXY (A, X and Y each
		 * represent all die values other than 1 or 5) Requirement 6.1.0 and
		 * 6.2.0
		 */
		...
		/*
		 * Test 106: Check scoring for a die roll of 15AAXx (A and X each
		 * represent all die values other than 1 or 5) Requirement 6.1.0 and
		 * 6.2.0
		 */
		...
		/*
		 * Test 109: Check scoring for a die roll of 155AAX (A and X each
		 * represent all die values other than 1 or 5) Requirement 6.1.0 and
		 * 6.2.0
		 */
		...
		/*
		 * Test 110: Check scoring for a die roll of 155AXY (A, X and Y each
		 * represent all die values other than 1 or 5) Requirement 6.1.0 and
		 * 6.2.0
		 */
		...
		/*
		 * Test 111: Check scoring for a die roll of 115AAX (A and X each
		 * represent all die values other than 1 or 5) Requirement 6.1.0 and
		 * 6.2.0
		 */
		...
		/*
		 * Test 112: Check scoring for a die roll of 115AXY (A, X and Y each
		 * represent all die values other than 1 or 5) Requirement 6.1.0 and
		 * 6.2.0
		 */
		...
		/*
		 * Test 113: Check scoring for a die roll of AAAXXY (A, X and Y
		 * represent all die values other than 1 or 5) Requirement 6.4.0
		 */
		...
		/*
		 * Test 114: Check scoring for a die roll of AAAXYZ (A, X, Y and Z
		 * represent all die values other than 1 or 5) Requirement 6.4.0
		 */
		...
		/*
		 * Test 115: Check scoring for a die roll of 555AAX (A and X represent
		 * all die values other than 1 or 5) Requirement 6.4.0
		 */
		...
		/*
		 * Test 117: Check scoring for a die roll of 111AAX (A and X represent
		 * all die values other than 1 or 5) Requirement 6.3.0
		 */
		...
		/*
		 * Test 118: Check scoring for a die roll of 111AXY (A, X and Y
		 * represent all die values other than 1 or 5) Requirement 6.3.0
		 */
		...
		/*
		 * Test 119: Check scoring for a die roll of 1AAAXX (A and X each
		 * represent all die values other than 1 or 5) Requirement 6.1.0 and
		 * 6.4.0
		 */
		...
		/*
		 * Test 120: Check scoring for a die roll of 1AAAXY (A, X and Y each
		 * represent all die values other than 1 or 5) Requirement 6.1.0 and
		 * 6.4.0
		 */
		...
		/*
		 * Test 121: Check scoring for a die roll of 5AAAXX (A and X each
		 * represent all die values other than 1 or 5) Requirement 6.2.0 and
		 * 6.4.0
		 */
		...
		/*
		 * Test 122: Check scoring for a die roll of 5AAAXY (A, X and Y each
		 * represent all die values other than 1 or 5) Requirement 6.2.0 and
		 * 6.4.0
		 */
		...
		/*
		 * Test 123: Check scoring for a die roll of 55AAAX (A and X each
		 * represent all die values other than 1 or 5) Requirement 6.2.0 and
		 * 6.4.0
		 */
		...
		/*
		 * Test 124: Check scoring for a die roll of 15AAAX (A and X each
		 * represent all die values other than 1 or 5) Requirement 6.1.0, 6.2.0,
		 * and 6.4.0
		 */
		...
		/*
		 * Test 125: Check scoring for a die roll of 11AAAX (A and X each
		 * represent all die values other than 1 or 5) Requirement 6.1.0 and
		 * 6.4.0
		 */
		...
		/*
		 * Test 126: Check scoring for a die roll of 155AAA (A represents all
		 * die values other than 1 or 5) Requirement 6.1.0, 6.2.0, and 6.4.0
		 */
		...
		/*
		 * Test 127: Check scoring for a die roll of 115AAA (A represents all
		 * die values other than 1 or 5) Requirement 6.1.0, 6.2.0, and 6.4.0
		 */
		...
		/*
		 * Test 128: Check scoring for a die roll of AAAXXX (A and X each
		 * represent all die values other than 1 or 5) Requirement 6.4.0
		 */
		...
		for (String numbers : automatedPermutations) {
			...
			for (List<Integer> currentNumbers : myPermutations) {
				...
				// Test the calculateHighestScore method
				highestScore = game.calculateHighestScore(currentNumbers);
				assertEquals(100 * dieOneValue + 100 * dieTwoValue,
						highestScore[0]);
				highestRoll = (List<Integer>) highestScore[1];
				assertEquals(highestRoll.size(), 6);
		...
		/*
		 * Test 129: Check scoring for a die roll of 555AAA (A represents all
		 * die values other than 1 or 5) Requirement 6.4.0
		 */
		...
		/*
		 * Test 130: Check scoring for a die roll of 111AAA (A represents all
		 * die values other than 1 or 5) Requirement 6.3.0 and 6.4.0
		 */
		...
		/*
		 * Test 131: Check scoring for a die roll of 111555 Requirement 6.3.0
		 * and 6.4.0
		 */
		...
		/*
		 * Test 132: Check scoring for a die roll of 5551AA (A represents all
		 * die values other than 1 or 5) Requirement 6.1.0 and 6.4.0
		 */
		...
		/*
		 * Test 133: Check scoring for a die roll of 5551AX (A and X each
		 * represent all die values other than 1 or 5) Requirement 6.1.0 and
		 * 6.4.0
		 */
		...
		/*
		 * Test 134: Check scoring for a die roll of 55511A (A represents all
		 * die values other than 1 or 5) Requirement 6.1.0 and 6.4.0
		 */
		...
		/*
		 * Test 135: Check scoring for a die roll of 1115AA (A represents all
		 * die values other than 1 or 5) Requirement 6.2.0 and 6.3.0
		 */
		...
		/*
		 * Test 136: Check scoring for a die roll of 1115AX (A and X each
		 * represent all die values other than 1 or 5) Requirement 6.2.0 and
		 * 6.4.0
		 */
		...
		/*
		 * Test 137: Check scoring for a die roll of 11155A (A represents all
		 * die values other than 1 or 5) Requirement 6.2.0 and 6.3.0
		 */
		...
		/*
		 * Test 138: Check scoring for a die roll of AAAAXX (A and X each
		 * represent all die values other than 1 or 5) Requirement 6.5.0
		 */
		...
		/*
		 * Test 139: Check scoring for a die roll of AAAAXY (A, X and Y each
		 * represent all die values other than 1 or 5) Requirement 6.5.0
		 */
		...
		/*
		 * Test 140: Check scoring for a die roll of 5555AA (A represents all
		 * die values other than 1 or 5) Requirement 6.5.0
		 */
		...
		/*
		 * Test 141: Check scoring for a die roll of 5555AX (A represents all
		 * die values other than 1 or 5) Requirement 6.5.0
		 */
		...
		/*
		 * Test 142: Check scoring for a die roll of 1111AA (A represents all
		 * die values other than 1 or 5) Requirement 6.5.0
		 */
		...
		/*
		 * Test 143: Check scoring for a die roll of 1111AX (A represents all
		 * die values other than 1 or 5) Requirement 6.5.0
		 */
		...
		/*
		 * Test 144: Check scoring for a die roll of 1AAAAX (A amd X each
		 * represent all die values other than 1 or 5) Requirement 6.1.0 and
		 * 6.5.0
		 */
		...
		/*
		 * Test 145: Check scoring for a die roll of 5AAAAX (A amd X each
		 * represent all die values other than 1 or 5) Requirement 6.2.0 and
		 * 6.5.0
		 */
		...
		/*
		 * Test 146: Check scoring for a die roll of 55AAAA (A represents all
		 * die values other than 1 or 5) Requirement 6.2.0 and 6.5.0
		 */
		...
		/*
		 * Test 147: Check scoring for a die roll of 15AAAA (A represents all
		 * die values other than 1 or 5) Requirement 6.1.0, 6.2.0, and 6.5.0
		 */
		...
		/*
		 * Test 148: Check scoring for a die roll of 11AAAA (A represents all
		 * die values other than 1 or 5) Requirement 6.1.0 and 6.5.0
		 */
		...
		/*
		 * Test 149: Check scoring for a die roll of 15555A (A represents all
		 * die values other than 1 or 5) Requirement 6.1.0 and 6.5.0
		 */
		...
		/*
		 * Test 150: Check scoring for a die roll of 115555 Requirement 6.1.0
		 * and 6.5.0
		 */
		...
		/*
		 * Test 151: Check scoring for a die roll of 11115A (A represents all
		 * die values other than 1 or 5) Requirement 6.2.0 and 6.5.0
		 */
		...
		/*
		 * Test 152: Check scoring for a die roll of 111155 Requirement 6.2.0
		 * and 6.5.0
		 */
		...
		/*
		 * Test 153: Check scoring for a die roll of AAAAAX (A and X each
		 * represent all die values other than 1 or 5) Requirement 6.5.0
		 */
		...
		/*
		 * Test 154: Check scoring for a die roll of 5AAAAA (A represents all
		 * die values other than 1 or 5) Requirement 6.2.0 and 6.5.0
		 */
		...
		/*
		 * Test 155: Check scoring for a die roll of 1AAAAA (A represents all
		 * die values other than 1 or 5) Requirement 6.1.0 and 6.5.0
		 */
		...
		/*
		 * Test 156: Check scoring for a die roll of 55555A (A represents all
		 * die values other than 1 or 5) Requirement 6.5.0
		 */
		...
		/*
		 * Test 157: Check scoring for a die roll of 155555 Requirement 6.1.0
		 * and 6.5.0
		 */
		...
		/*
		 * Test 158: Check scoring for a die roll of 11111A (A represents all
		 * die values other than 1 or 5) Requirement 6.5.0
		 */
		...
		/*
		 * Test 159: Check scoring for a die roll of 111115 Requirement 6.2.0
		 * and 6.5.0
		 */
		...
		/*
		 * Test 160: Check scoring for a die roll of AAAAAA (A represents all
		 * die values other than 1 or 5) Requirement 6.5.0
		 */
		...
		/*
		 * Test 161: Check scoring for a die roll of 555555 Requirement 6.5.0
		 */
		...
		/*
		 * Test 162: Check scoring for a die roll of 111111 Requirement 6.5.0
		 */
	...
	/**
	 * The permutations method is a wrapper class to the stringPermutations
	 * method. This method passes a string of integers for which the
	 * permutations are sought to the stringPermutations method that then
	 * returns a list of all the string permutations of the input string. The
	 * permutations method than converts the list of strings to a list of lists
	 * of integers.
	 * 
	 * @param myString
	 *            string of integers for which all permutations are sought
	 * @return List of Lists of integers representing distinct permutations of
	 *         the input string
	 */
	public static List<List<Integer>> permutations(String myString) {
		...
		// For each string in myList, convert that string to a list of integers
		// and add
		...
		for (String number : myList) {
			...
			for (int i = 0; i < number.length(); i++) {
				currentPermutation.add(Character.getNumericValue(number
						.charAt(i)));
			}
	...
	/**
	 * The stringPermutation method uses recursion to find all permutations of a
	 * string of characters, returning a list of those strings
	 * 
	 * @param myString
	 *            string of characters for which all permutations are to be
	 *            found
	 * @return List of strings representing all distinct permutations of the
	 *         input string
	 */
	public static List<String> stringPermutations(String myString) {
		...
		// If the length of myString is less than 2, there are no more
		...
		for (int i = 0; i < length; i++) {
			...
			// Retrieve all of the permutations for a substring excluding the
			// current character
			List<String> subPermutations = stringPermutations(subString);

			// For each permutation of the substring, add the string that
	...
	/**
	 * The integerPermutations method converts a string, representing a Farkle
	 * dice roll, into a list of strings including all roll permutations for the
	 * input string.
	 * 
	 * @param myString
	 *            input string to be converted, with variables as placeholders
	 *            for dice that could be 2,3,4 or 6. E.g. the string "1AABC"
	 *            represents a roll including a die with the value 1, and 4 dice
	 *            with the value 2 through 6. For each permuation, 2 of the 4
	 *            dice, represented by A, are of the same value. On a given
	 *            roll, the value for die B never equals that for A or C, and
	 *            the value of die C never equals that for A or B.
	 * @return List of strings with all permutations of 2, 3, 4, or 6 valued die
	 *         in place of variables in the input string. E.g. an input string
	 *         of "1A" would return the list {"12", "13", "14", "16"}
	 */
	public static List<String> integerPermutations(String myString) {
		...
		// List of strings representing the roll permutations calculated from
		// the input string
		...
		for (int i = 0; i < length; i++) {
			...
			// If the current character is a letter, and the variables list is
			// empty or the variables list does not contain the letter
			// Add it to the variables list
			if (Character.isLetter(currentCharacter)
					&& (presentVariables.isEmpty() || !presentVariables
		...
		// the string representing each possible permutation to the
		// rollPermutations
		// list
		if (numberOfVariables > 0 && numberOfVariables <= 4) {
			...
			for (int i = 2; i <= 6; i++) {
				...
				if (numberOfVariables > 1) {
					for (int j = 2; j <= 6; j++) {
						...
						if (numberOfVariables > 2) {
							for (int k = 2; k <= 6; k++) {
								...
								// Embedded loop for a variable representing a
								// fourth die
								if (numberOfVariables > 3) {
									for (int l = 2; l <= 6; l++) {
										...
										// Loop through the input string adding
										// this permutation of the roll.
										for (int x = 0; x < length; x++) {
											// Clear the currentPermutation
											// String
											currentCharacter = myString
													.charAt(x);

											// If the current character is a
											// letter, and the variables list is
											// empty
											// or the variables list does not
											// contain the letter, add it to the
											// variables
											// list
											if (Character
													.isLetter(currentCharacter)) {
												switch (presentVariables
										...
										rollPermutations
												.add(currentPermutation);
									}
								} else {
									// Clear the currentPermutation String
									currentPermutation = "";

									// Loop through the input string adding this
									// permutation of the roll.
									for (int x = 0; x < length; x++) {
										currentCharacter = myString.charAt(x);

										// If the current character is a letter,
										// and the variables list is empty
										// or the variables list does not
										// contain the letter, add it to the
										// variables
										// list
							...
							for (int x = 0; x < length; x++) {
								...
								// If the current character is a letter, and the
								// variables list is empty
								// or the variables list does not contain the
								// letter, add it to the variables
								// list
								if (Character.isLetter(currentCharacter)) {
									switch (presentVariables
											.indexOf(currentCharacter)) {
					...
					// Loop through the input string adding this permutation of
					// the roll.
					for (int x = 0; x < length; x++) {
						currentCharacter = myString.charAt(x);
						...
						// If the current character is a letter, and the
						// variables list is empty
						// or the variables list does not contain the letter,
		...
		// If more than 4 variables were in the string it is incorrect input,
		// return null
		else if (numberOfVariables > 4) {
			return null;
		} else {
			// There are no variables present to perform the permutation on,
			// simply add myString
