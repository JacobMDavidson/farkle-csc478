...
public class FarkleController implements ActionListener, MouseListener {
	...
	public void farkle() {
		...
		/******************************************************************
		 * 1.2.7: If any roll results in 0 points, the word ï¿½Farkle!!!ï¿½ is
	...
	public void newGame() {
		...
		/************************************************************************
		 * 1.1.2a - If the user selects the ï¿½Startï¿½ button with ï¿½1 Player
		 * Modeï¿½ highlighted and the ï¿½Player One Nameï¿½ field empty, the
		...
		if (farkleOptions.getPlayer1Name().length() == 0) {
			...
			/*************************************************************************
			 * 1.1.2b - If the user selects the ï¿½Startï¿½ button with ï¿½1
			 * Player Modeï¿½ highlighted and a name supplied in the ï¿½Player
			 * One Nameï¿½ text field, the one player GUI (section 1.3.0) opens
		...
		if (farkleOptions.getGameMode() == GameMode.MULTIPLAYER) {
			...
			/******************************************
			 * 1.3.1 - The title of the window shall display: ï¿½Farkle ï¿½
			 * Single Player Modeï¿½.
			 ******************************************/
	...
	public void actionPerformed(ActionEvent arg0) {
		 ...
		 * to display their last value , the ï¿½Roll Diceï¿½ button is enabled,
		 * the ï¿½Bank Scoreï¿½ button is disabled, the ï¿½Select Allï¿½ button
	...
	public boolean gameEnded(boolean resetOnly, boolean mainMenu) {
		...
		if ((!resetOnly) && (!mainMenu)) {
			 ...
			 * displayed with the playerï¿½s overall score for the completed
			 ...
			 * include with three options: ï¿½Play Aagain?ï¿½, ï¿½Main Menuï¿½,
			 * and ï¿½Quitï¿½.
			 *************************************************/

			/**************************************************
			 * 2.1.4 - The player is given three options: ï¿½Play again?ï¿½,
			 * ï¿½Main Menuï¿½, and ï¿½Quitï¿½.
			 **************************************************/

			/**************************************************
			 * 2.2.4 - A congratulatory message to the winner is displayed, and
			 * three options are given: ï¿½Play again?ï¿½, ï¿½Main Menuï¿½, and
			 * ï¿½Quitï¿½.
			 **************************************************/

			/**************************************************
			 * 2.2.13 - A ï¿½You Win!!ï¿½ or ï¿½You Loseï¿½ï¿½ message is
			 * displayed depending on if the live player won or lost the game,
			 * and three options are given: ï¿½Play again?ï¿½, ï¿½Main Menuï¿½,
			 * and ï¿½Quitï¿½.
			 **************************************************/
			String message = "";
			...
			/************************************************
			 * 2.2.5 - If ï¿½Play again?ï¿½ is selected, the game starts over in
			 * 2 player mode against a live person.
			 ************************************************/

			/************************************************
			 * 2.2.14 - If ï¿½Play again?ï¿½ is selected, the game starts over
			...
			/************************************************
			 * 2.2.6 - If ï¿½Main Menuï¿½ is selected, the user is taken to the
			 * mode selection screen.
			 ************************************************/

			/************************************************
			 * 2.2.15 - If ï¿½Main Menuï¿½ is selected, the user is taken to the
			 * mode selection screen.
			 ************************************************/
			else if (n == 1) {
				retVal = false;
			...
			/**************************************************
			 * 2.2.7 - If ï¿½Quitï¿½ is selected, the application immediately
			 * closes.The conclusion of game option box (section 1.5.0) is
			 * displayed after a player wins
			 **************************************************/

			/**************************************************
			 * 2.2.16 - If ï¿½Quitï¿½ is selected, the application immediately
			 * closes.The conclusion of game option box (section 1.5.0) is
			 * displayed after a player wins.
			 **************************************************/
			else {
	...
	public void rollHandler() {
		if (farkleUI.getRollBtnText().equals("Roll Dice")) {
			 ...
			 * score, a selected dice score of 0 is displayed and the ï¿½Roll
			 * Diceï¿½ and ï¿½Bank Scoreï¿½ buttons are disabled.
			 *************************************************/
			farkleUI.getRollBtn().setEnabled(false);
			farkleUI.getBankBtn().setEnabled(false);
