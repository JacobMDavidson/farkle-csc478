...
/**
 * The Player class creates a player object that tracks the roll scores, game
 * score, player number, player type, player name, turn number, roll number,
 * turn scores, and game score for this player.
 * 
...
public class Player {
	...
	/**
	 * Constructor: Takes player number and initializes the turnScores
	 * 
	 * @param playerNumber
	 ...
	 * 
	 * @param score
	 *            The integer score to enter into the rollScore map
	 */
	...
	/**
	 * Get the sum of all the roll scores
	 * 
	 ...
	 * 
	 * @param didFarkle
	 *            Set to true if the end of the turn was caused by a Farkle
	 */
	 ...
	 * 
	 * @param turnScores
	 *            ArrayList<Integer> of turn scores to set
	 */
