 ...
 * 1.0.0
 * 
 * Select Game Mode Option Box – Upon opening the application,
 *  the user is greeted with an option box that includes all
 *  configuration options for gameplay. These options include
 *  “1 Player Mode”, “2 Player Mode”, “Human Opponent”
 *  (if two player mode is selected), “Computer Opponent” 
 *  (if two player mode is selected), and text fields to 
 *  enter the associated player names. Also included is a 
 *  “Start” button and a “Close” button (both of which are always enabled).
 *  This option dialog box should pop up over the main GUI (section 1.2.0).
 *
 *****************************************************************************/
public class FarkleOptionsDialog extends JDialog implements MouseListener {
	...
	private JLabel singlePlayerLabel = new JLabel("One Player Mode", SwingConstants.CENTER);
	private JLabel multiplayerLabel = new JLabel("Two Player Mode", SwingConstants.CENTER);
	private JLabel playerTypeSelectLabel = new JLabel(" Select Opponent Type:");
	private JLabel humanPlayerLabel = new JLabel("Human Opponent", SwingConstants.CENTER);
	private JLabel computerPlayerLabel = new JLabel("Computer Opponent", SwingConstants.CENTER);
	private JLabel gameModeOptionTitle = new JLabel("Game Mode Options", SwingConstants.CENTER);
	...
	public FarkleOptionsDialog() {
		...
		/********************************************************
		 * 1.1.2 - The “1 Player Mode” is highlighted by default
		 *  when the application is first opened, and a blank
		 *   text field for player one’s name is displayed. 
		 ********************************************************/
		...
		startButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				gameMode = (null == gameMode) ? GameMode.SINGLEPLAYER : gameMode;
				
				try {
						if (("Ginuwine")
								.equalsIgnoreCase(player1Name)) {
							URL gSound = getClass().getResource("/sounds/roll5.wav");
		...
		/**********************************************
		 * 1.1.1
		 * If the user selects the “Close” button
		 *  at any time, the application closes.
		 **********************************************/
	...
	public void mouseClicked(MouseEvent e) {
		...
		// Multiplayer
		/**************************************************************
		 * 1.1.3 - If the user highlights the “2 Player Mode” option,
		 * the “1 Player Mode” option is deselected, and two more
		 *  options appear (“Human Opponent” and “Computer Opponent”).
		 *   The “Human Opponent” option is highlighted by default.
		 **************************************************************/
		...
		// Human
		/****************************************************************
		 * 1.1.4 - When the “Human Opponent” option is highlighted,
		 * two text fields are displayed, labeled “Player One Name”,
		 *  and “Player Two Name”.
		 ****************************************************************/
		...
		// Computer
		/****************************************************************
		 * 1.1.5 - When the “Computer Opponent” option is highlighted,
		 *  only one text field is displayed, labeled “Player One Name”.
		 ****************************************************************/
